...
public class CatchData
{
    ...
    internal CatchData Uptime(int startMinute, int endMinute)
    {
        Interval = RepeatingInterval.FromEorzeanMinutes(startMinute, endMinute);
        return this;
    }
    ...
    public RepeatingInterval Interval { get; private set; } = RepeatingInterval.Always;
