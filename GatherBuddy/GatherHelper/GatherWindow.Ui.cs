...
public class GatherWindow : Window
{
    ...
    private static string TooltipText(ILocation? loc, TimeInterval time)
    {
        ...
        string startStr = GatherBuddy.Config.GatherWindowRFC3339HoverDates ? time.Start.LocalTime.ToString("yyyy-MM-dd HH:mm:ss") : time.Start.ToString();
        string endStr = GatherBuddy.Config.GatherWindowRFC3339HoverDates ? time.End.LocalTime.ToString("yyyy-MM-dd HH:mm:ss") : time.End.ToString();
