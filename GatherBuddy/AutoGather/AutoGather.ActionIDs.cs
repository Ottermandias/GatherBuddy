...
public partial class AutoGather
{
    public static class Actions
    {
        ...
        public static readonly BaseAction TwelvesBounty = new(  282,   280,   825);
        public static readonly BaseAction Bountiful     = new( 4087,  4073,   756);
        public static readonly BaseAction SolidAge      = new(  215,   232,  2765);
        public static readonly BaseAction Yield1        = new(  222,   239,   219);
        public static readonly BaseAction Yield2        = new(  224,   241,   219);
        ...
        public static readonly BaseAction BountifulII   = new(  273,   272,   1286);
        public static readonly BaseAction GivingLand    = new( 4590,  4589,   1802);
        public static readonly BaseAction Wise          = new(26522, 26521);
