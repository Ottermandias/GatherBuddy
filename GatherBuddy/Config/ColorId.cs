...
public static class ColorIdExtensions
{
    ...
    public static (uint DefaultColor, string Name, string Description) Data(this ColorId color)
        => color switch
        {
            ...
            ColorId.FishTimerLureNoCatch                   => (0xEF404040, "Fish Timer Window Lure Dead Zone",                               "Block indicating time when fish may not be caught due to Lure Cooldown"), // A nice transparent grey for a box to indicate that no fish may be caught during this time. 
