...
public static partial class Fish
{
    ...
    private static void ApplyDawntrail(this GameData data)
    {
        ...
        data.Apply(17951, Patch.Dawntrail); // Dafangshi
        data.Apply(29573, Patch.Dawntrail); // Splendid Piranha
        data.Apply(29574, Patch.Dawntrail); // Splendid Pirarucu
        data.Apply(29578, Patch.Dawntrail); // Splendid Sponge
